...
ylim([0 1000])
xlim([0 100])
title(['Diffusion spheres can exceed boundaries by ',num2str(exceedBoundaryDist),' um'])
ylim([0 numReactants])
xlim([0 100])
hold off
...
yticks([0,60,3600,2*3600,3*3600,4*3600,7*3600])
yticklabels({'0','1 minute','1 hour','2 hours','3 hours','4 hours','7 hours'})
ylim([0 9*3600])
xticks([0,10,10^2,10^3,10^4,10^5])
xticklabels({'0','10','10^2','10^3','10^4','10^5'})
xlim([0 11^5])
