function [ PQueue,initial_events,lists_cell ] = initializeRxQueue_____finiteParticleSize( assemblyDistMatrix,...
    currentAssemblyIDs,...
...
%         IntegratedPropensity_curve = Integrated_propensities(d_index,:);
